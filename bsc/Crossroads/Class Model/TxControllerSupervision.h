...
class TxControllerSupervision : public TxController {
public:
	...
	bool configure(InputPort iPort, UniversalInput iType = ANALOG_5KOMEGA);
	...
	/*! Diese Methode ermöglicht zur Fehlersuche, Zeichenketten in die Ausgabedatei (siehe
		...
		\param note Gibt die Zeichenkette zus Ausgabe an. */
