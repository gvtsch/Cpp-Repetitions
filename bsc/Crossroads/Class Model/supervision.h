...
void StartSupervision(ReactiveModel* model, ReactiveModelMode mode =REACTIVE, const char* ofile ="txcontroller.txt", 
...
void SetAnnotationSupervision(const char* note);
